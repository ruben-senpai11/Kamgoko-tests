        ...
        <div className=" line d-flex flex-column gap-0 mt-4 ">
          <div className="spacing d-flex align-items-center justify-content-between gap-2 ">
            <div className="d-flex align-items-center justify-content-between gap-4 ">
              <p className="d-flex align-items-center justify-content-between gap-2 actions ">
          ...
          <hr />
          <div className="spacing payments d-flex align-items-center justify-content-between mt-4 ">
